...
# router.apollographql.com/router-operator-bundle:$VERSION and router.apollographql.com/router-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= router.apollographql.com/router-operator
